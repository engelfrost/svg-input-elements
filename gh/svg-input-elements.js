...
(function() {
  ...
  window.addEventListener("click", function(e) {
    return paintPoint(e.clientX, e.clientY);
  });

  paintPoint = function(x, y) {
    var div;
    ...
    return console.log("red dot at", x, y);
  };
...
(function() {
  ...
  controllerPrototype = {
    focusedTextarea: function(textarea) {
      if (textarea === void 0) {
...
(function() {
  ...
  controllerPrototype = {
    ...
    repos: function() {
      ...
      if (this.isEnd()) {
        this.model.textarea("height", Math.max(this.facet("dy"), this.model.textarea("height")));
      } else {
        this.model.next("repos");
      }
      return this.model.dx;
    ...
    controller.model = {
      ...
      view: (function() {
        ...
        v.addEventListener("click", function(e) {
          var charNum, charRect, cursor, cursorPoint, p, textareaDimensions, x, y;
          textarea("focus");
          textareaDimensions = textarea("view").getBoundingClientRect();
          x = e.clientX - textareaDimensions.left;
          y = e.clientY - textareaDimensions.top;
