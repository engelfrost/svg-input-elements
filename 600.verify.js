...
$(document).ready(function(){
	...
	var svg = $('#svg-container').svg({onLoad: init, clear: true, settings: {viewBox: '0 0 400 200'}});
...
function readyStart(svg){
  ...
  svg.input.textArea(50, 0, 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Aliquam erat volutpat. Sed nibh tortor, venenatis non scelerisque ut, consequat vitae lacus. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.\nMaecenas velit ipsum, congue rutrum congue nec, tristique eu nunc. Pellentesque luctus egestas velit, elementum posuere magna viverra et. Fusce rhoncus purus vitae ante dictum convallis.\nVestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aliquam tempor tempus blandit. Curabitur nisi sapien, viverra non imperdiet vitae, tristique et diam.', {width: '300'});
